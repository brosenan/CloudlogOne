...
treap:mergeTree(nil, t(L, K, W, V, H, R), t(L, K, W, V, H, R)).
treap:mergeTree(t(L, K, W, V, H, R), nil, t(L, K, W, V, H, R)).
...
treap:delete(t(L, K, W, V, H, R), K1, T) :-
	if(K = K1,
